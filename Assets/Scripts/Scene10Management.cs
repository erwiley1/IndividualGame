...
public class Scene10Management : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0) && CannonPlaced == false)
        {
            ...
            newCannon.transform.position = new Vector2(0, newPosition.y);
    ...
    public IEnumerator WaitToLoad()
    {
        ...
        SceneManager.LoadScene("_Scene_11");
    }
